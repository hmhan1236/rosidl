...
# @public
#
macro(rosidl_export_typesupport_targets library_suffix single_typesupport)
  ...
  if(${ARGC} GREATER 0)
    ...
    foreach(_target ${ARGN})
      ...
      list(APPEND _ROSIDL_CMAKE_EXPORT_TYPESUPPORT_TARGETS "${library_suffix}:${_target}:${single_typesupport}")
    endforeach()
  endif()
endmacro()
